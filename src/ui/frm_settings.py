...
# Form implementation generated from reading ui file '/home/fernando/proyectos_kan/plugins-qgis/kan-imagery-catalog/QGIS-KICa/src/ui/frm_settings.ui'
#
...
class Ui_frm_settings(object):
    def setupUi(self, frm_settings):
        ...
        frm_settings.resize(645, 500)
        frm_settings.setMinimumSize(QtCore.QSize(535, 500))
        ...
        self.lbl_download_path = QtWidgets.QLabel(self.frame_2)
        self.lbl_download_path.setObjectName("lbl_download_path")
        self.gridLayout_8.addWidget(self.lbl_download_path, 2, 0, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.txt_max_features_results, 4, 1, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.frame_6, 1, 1, 1, 2)
        ...
        self.gridLayout_8.addWidget(self.btn_download_dir, 2, 2, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.txt_download_path, 2, 1, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.txt_default_back_days, 0, 1, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.lbl_cloud_coverage, 1, 0, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.lbl_days_after, 0, 0, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.txt_max_catalog_results, 3, 1, 1, 1)
        ...
        self.lbl_up42_username = QtWidgets.QLabel(self.frame_up42_credentials)
        self.lbl_up42_username.setObjectName("lbl_up42_username")
        self.gridLayout_7.addWidget(self.lbl_up42_username, 0, 0, 1, 1)
        self.txt_up42_username = QtWidgets.QLineEdit(self.frame_up42_credentials)
        self.txt_up42_username.setMinimumSize(QtCore.QSize(0, 30))
        self.txt_up42_username.setMaximumSize(QtCore.QSize(16777215, 30))
        self.txt_up42_username.setMaxLength(512)
        self.txt_up42_username.setObjectName("txt_up42_username")
        self.gridLayout_7.addWidget(self.txt_up42_username, 0, 1, 1, 1)
        self.lbl_up42_password = QtWidgets.QLabel(self.frame_up42_credentials)
        self.lbl_up42_password.setObjectName("lbl_up42_password")
        self.gridLayout_7.addWidget(self.lbl_up42_password, 1, 0, 1, 1)
        self.txt_up42_password = QtWidgets.QLineEdit(self.frame_up42_credentials)
        self.txt_up42_password.setMinimumSize(QtCore.QSize(0, 30))
        self.txt_up42_password.setMaximumSize(QtCore.QSize(16777215, 30))
        self.txt_up42_password.setMaxLength(512)
        self.txt_up42_password.setEchoMode(QtWidgets.QLineEdit.Password)
        self.txt_up42_password.setObjectName("txt_up42_password")
        self.gridLayout_7.addWidget(self.txt_up42_password, 1, 1, 1, 1)
        ...
        frm_settings.setTabOrder(self.tabWidget, self.txt_up42_username)
        frm_settings.setTabOrder(self.txt_up42_username, self.txt_up42_password)

    def retranslateUi(self, frm_settings):
        _translate = QtCore.QCoreApplication.translate
        frm_settings.setWindowTitle(_translate("frm_settings", "Settings"))
        self.lbl_download_path.setText(_translate("frm_settings", "Download path"))
        ...
        self.lbl_up42_username.setText(_translate("frm_settings", "Username"))
        self.lbl_up42_password.setText(_translate("frm_settings", "Password"))
