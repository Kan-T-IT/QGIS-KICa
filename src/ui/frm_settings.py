...
# Form implementation generated from reading ui file '/home/fernando/proyectos_kan/plugins-qgis/qgis-plugin-satelital/src/ui/frm_settings.ui'
#
...
class Ui_frm_settings(object):
    def setupUi(self, frm_settings):
        ...
        frm_settings.resize(645, 550)
        frm_settings.setMinimumSize(QtCore.QSize(535, 550))
        ...
        self.lbl_days_after.setMinimumSize(QtCore.QSize(180, 0))
        self.lbl_days_after.setMaximumSize(QtCore.QSize(180, 16777215))
        ...
        self.frame = QtWidgets.QFrame(self.tab_up42)
        ...
        self.lbl_project_id = QtWidgets.QLabel(self.frame)
        self.lbl_project_id.setObjectName("lbl_project_id")
        self.gridLayout_7.addWidget(self.lbl_project_id, 0, 0, 1, 1)
        self.txt_up42_project_id = QtWidgets.QLineEdit(self.frame)
        ...
        self.lbl_api_key = QtWidgets.QLabel(self.frame)
        self.lbl_api_key.setObjectName("lbl_api_key")
        self.gridLayout_7.addWidget(self.lbl_api_key, 1, 0, 1, 1)
        self.txt_up42_api_key = QtWidgets.QLineEdit(self.frame)
        ...
        self.frame_4 = QtWidgets.QFrame(self.tab_sentinel)
    ...
    def retranslateUi(self, frm_settings):
        ...
        self.label.setText(_translate("frm_settings", "Ruta de descarga"))
        ...
        self.lbl_cloud_coverage.setText(_translate("frm_settings", "Nubosidad máxima por defecto (0%)    "))
        self.label_2.setText(_translate("frm_settings", "Cant. máxima de catálogos"))
        self.lbl_language.setText(_translate("frm_settings", "Idioma"))
        self.lbl_days_after.setText(_translate("frm_settings", "Cantidad de días de consulta"))
        self.label_3.setText(_translate("frm_settings", "Cant. máxima de objetos por catalogo"))
        self.lbl_project_id.setText(_translate("frm_settings", "Project ID"))
        self.lbl_api_key.setText(_translate("frm_settings", "Api ID"))
        self.btn_up42_check_credentials.setText(_translate("frm_settings", "Verificar credenciales"))
        ...
        self.label_4.setText(_translate("frm_settings", "Próximamente..."))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_sentinel), _translate("frm_settings", "SentinelHub"))
        self.label_5.setText(_translate("frm_settings", "Próximamente..."))
